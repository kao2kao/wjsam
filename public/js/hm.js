(function () {
    var h = {}, mt = {}, c = {
        id: "d536102a366ddc89e5d17894aed60614",
        dm: ["liuzhuni.com"],
    ...
    (mt.r.Ga = function () {
        ...
        (function () {
            if (!f)if (f = q, "complete" === document.readyState)a.C = q; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
                b, s), window.addEventListener("load", a, s); else if (document.attachEvent) {
                    ...
                    if (d instanceof Array) {
                        ...
                        for (g = 0; g < f; g++)switch (k = d[g], typeof k) {
                            ...
                            case "unknown":
                                break;
                            default:
                                p && b.push(","), b.push(mt.l.stringify(k)), p = 1
                        }
                        b.push("]");
                        return b.join("")
                    }
    ...
    (function () {
        var a = mt.r, e = mt.event, f = mt.j, d = h.q, b = [], m = {
            aa: function () {
                c.ctrk && (e.c(document, "mouseup", m.fa()), e.c(window, "unload", function () {
                    m.D()
    ...
    (function () {
        ...
        function e() {
            ...
            if ((!p || !k) && g && l)u = q, n = +new Date; else if (p && k && (!g || !l))u = s, t += +new Date - n;
            p = g;
            k = l;
            x = setTimeout(e, 100)
        }
        ...
        function f(a) {
            var n = document, k = "";
            if (a in n)k = a; else for (var t = ["webkit", "ms", "moz", "o"], b = 0; b < t.length; b++) {
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))l = "focus" == a.type || "focusin" == a.type ? q : s, e()
        }

        var b = mt.event, m = h.A, p = q, g = q, k = q, l = q, v = +new Date, n = v, t = 0, u = q, w = f("visibilityState"), y = f("hidden"), x;
        e();
        (function () {
    ...
    (function () {
        var a = mt.lang, e = h.q, f = h.load, d = {
            Da: function (b) {
    ...
    (function () {
        ...
        var f = mt.lang, d = mt.l, b = h.q, m = h.A, p = h.ka, g = {
            s: [], F: 0, X: s, init: function () {
                g.d = 0;
                m.c("pv-b", function () {
                    g.la();
                    g.ma()
                ...
                if (1 < a.length && (a = a[1], s === a || q === a))g.d |= 2, h.b.U = a
                ...
                if (f.e(e, "Object")) {
                    ...
                    if (900 >= m)l.call(this, e); else for (var m = Math.ceil(m / 900), n = "block|" + Math.round(Math.random() *
                            b.w).toString(16) + "|" + m + "|", t = [], u = 0; u < m; u++)t.push(u), t.push(e.substring(900 * u, 900 * u + 900)), l.call(this, n + t.join("|")), t = []
                }
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = q, this.a = {}, this.U = q, this.K = s, this.init())
        }

        var e = mt.url, f = mt.P, d = mt.Q, b = mt.lang, m = mt.cookie, p = mt.j, g = mt.localStorage, k = mt.sessionStorage, l = h.q, v = h.A;
        a.prototype = {
            L: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                try {
                    m.set(a, b, {domain: this.J(), path: this.S(), I: d}), d ? g.set(a, b, d) : k.set(a, b)
                } catch (e) {
                }
            }, Ha: function (a) {
                try {
                    m.set(a, "", {domain: this.J(), path: this.S(), I: -1}), k.remove(a), g.remove(a)
                } catch (b) {
                }
            }, Ma: function () {
                var a, b, d, e, f;
                ...
                try {
                    this.Na(), 0 === this.a.nv ? this.Ka() :
                        this.O(".*"), h.b = this, this.ea(), v.z("pv-b"), this.Ja()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                var a = document.location.hash.substring(1), b = RegExp(c.id), d = -1 < document.referrer.indexOf(l.ca), f = e.k(a, "jn"), g = /^heatlink$|^select$/.test(f);
                a && (b.test(a) && d && g) && (this.a.rnd = Math.round(Math.random() * l.w), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", l.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a,
                    f))
            }, ba: function (a) {
    ...
    (function () {
        var a = mt.r, e = mt.event, f = mt.url, d = mt.l;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                var b = +new Date, m = function (a) {
                ...
                var g = function () {
                    ...
                    e = r;
                    if ("www.baidu.com" === k[2] || "m.baidu.com" === k[2])u = f.k(a, "qid"), e = f.k(a, "click_t");
                    a = u;
                    g.qid = a != r ? a : "";
    ...
    (function () {
        var a = mt.lang, e = mt.event, f = mt.l;
        if (c.comm && "undefined" !== typeof h.b) {
            var d = function (a) {
                ...
                return [].slice.call(a)
            }, b = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, m = {
                click: function () {
                    for (var a = [], e = d(document.getElementsByTagName("a")), e = [].concat.apply(e, d(document.getElementsByTagName("area"))), e = [].concat.apply(e, d(document.getElementsByTagName("img"))), f = 0, g = e.length; f < g; f++) {
                        var k = e[f],
                            m = k.getAttribute("onclick"), k = k.getAttribute("href");
                        (b.test(m) || b.test(k)) && a.push(e[f])
                    }
                    return a
                }
            }, p = function (a, b) {
                ...
                g.v = d;
                if (e) {
                    var k = e.getAttribute("href"), m = e.getAttribute("onclick") ? "" + e.getAttribute("onclick") : r, l = e.getAttribute("id") || "";
                ...
                if (k === d)return g(l + b, d), s;
                if (a.e(d, "Array") || a.e(d, "NodeList"))for (var e = 0, f = d.length; e < f; e++)if (k === d[e])return g(l + b + "/" + (e + 1), d[e]), s
            };
            e.c(document, "click", function (b) {
                b = b || window.event;
                k = b.target || b.srcElement;
                var d = {};
                for (p(m, function (b, e) {
    ...
    (function () {
        ...
        a.prototype = {
            Ea: function (a) {
                if (this.f)this.h(a, 0); else if (this.isSupported()) {
                    try {
                        this.f = new ActiveXObject("BDEXIE.BDExExtension.1"), this.W = q
                    } catch (d) {
                        this.W = s
                    }
                ...
                var a = this;
                this.qa(function (d) {
                    void 0 !== d && "" !== d && (e.log("//datax.baidu.com/x.gif?dm=" +
                        encodeURIComponent("datax.baidu.com/webadapter/guid") + "&ac=" + encodeURIComponent(d) + "&v=hm-webadapter-0.0.1&rnd=" + Math.round(2147483647 * Math.random())), a.La("hmKey", +new Date, function () {
                        a.Pa()
                    }))
                })
            }
        ...
        if (f.V && /^http(s)?:$/.test(document.location.protocol)) {
            var d = new a;
            d.Ea(function (a) {
                0 === a && d.ta("hmKey", function (a) {
                    a = +a;
                    (isNaN(a) || 6048E5 < +new Date - a) && d.Fa()
                })
            })
        }
    })();
