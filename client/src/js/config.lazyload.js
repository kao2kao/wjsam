 ...
 */
    .constant('JQ_CONFIG', {
        ...
        carousel: ['vendor/jquery/carousel/owl.carousel.min.js',
            'vendor/jquery/carousel/owl.carousel.css'],
        flexslider: ['vendor/jquery/flexslider/jquery.flexslider-min.js',
            'vendor/jquery/flexslider/flexslider.css'],
        queryloader2: ['vendor/jquery/queryloader2/jquery.queryloader2.min.js'],
        revolution: ['vendor/jquery/revolution/js/jquery.themepunch.plugins.min.js',
            'vendor/jquery/carousel/js/jquery.themepunch.revolution.min.js'],
    }
)
    // oclazyload config
